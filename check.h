...
// Wed Mar 18 14:25:32 2026 by ROOT version 6.36.04
// from TTree G2TauTree/yy->tautau ntuple
// found on file: Data/jpsi_cell_sig_sampling.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Data/jpsi_cell_sig_sampling.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Data/jpsi_cell_sig_sampling.root");
      }
