...
// Thu Nov 20 19:02:19 2025 by ROOT version 6.36.04
// from TTree G2TauTree/yy->tautau ntuple
// found on file: /Users/szymon/Downloads/data23_2trk_moreTCvars.root
//////////////////////////////////////////////////////////

#ifndef AnalysisData23_h
#define AnalysisData23_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   AnalysisData23(TTree *tree=0);
   virtual ~AnalysisData23();
...
#ifdef AnalysisData23_cxx
AnalysisData23::AnalysisData23(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/szymon/Downloads/data23_2trk_moreTCvars.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Users/szymon/Downloads/data23_2trk_moreTCvars.root");
      }
...
AnalysisData23::~AnalysisData23()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t AnalysisData23::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnalysisData23::LoadTree(Long64_t entry)
{
...
void AnalysisData23::Init(TTree *tree)
{
...
void AnalysisData23::Show(Long64_t entry)
{
...
Int_t AnalysisData23::Cut(Long64_t entry)
{
...
#endif // #ifdef AnalysisData23_cxx
