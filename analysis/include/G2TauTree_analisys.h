...
// Sun Nov 16 10:53:42 2025 by ROOT version 6.36.000
// from TTree G2TauTree/yy->tautau ntuple
// found on file: /Volumes/Sandisk_Macbook_Pro_1tb/electron_muon_project/data/jpsi_psi2s_extra_variables.root
//////////////////////////////////////////////////////////

#ifndef G2TauTree_analisys_h
#define G2TauTree_analisys_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   G2TauTree_analisys(const char* inputFile, const char* outputFile);
   virtual ~G2TauTree_analisys();
...
#ifdef G2TauTree_analisys_cxx
G2TauTree_analisys::G2TauTree_analisys(const char* inputFile, const char* outputFile)
    : fChain(0)
{
...
G2TauTree_analisys::~G2TauTree_analisys()
{
    if (fOut) {
...
Int_t G2TauTree_analisys::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t G2TauTree_analisys::LoadTree(Long64_t entry)
{
...
void G2TauTree_analisys::Init(TTree *tree)
{
...
bool G2TauTree_analisys::Notify()
{
...
void G2TauTree_analisys::Show(Long64_t entry)
{
...
Int_t G2TauTree_analisys::Cut(Long64_t entry)
{
...
#endif // #ifdef G2TauTree_analisys_cxx
