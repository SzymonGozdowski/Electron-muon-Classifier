...
// Wed Dec 17 21:13:31 2025 by ROOT version 6.36.000
// from TTree G2TauTree/yy->tautau ntuple
// found on file: data23_2trk_moreTCvars.root
//////////////////////////////////////////////////////////

#ifndef G2TauTree_data23_analysis_h
#define G2TauTree_data23_analysis_h
...
class G2TauTree_data23_analysis {
public :
...
Long64_t G2TauTree_data23_analysis::LoadTree(Long64_t entry)
{
...
void G2TauTree_data23_analysis::Init(TTree *tree)
{
...
void G2TauTree_data23_analysis::Show(Long64_t entry)
{
...
Int_t G2TauTree_data23_analysis::Cut(Long64_t entry)
{
